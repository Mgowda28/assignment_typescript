...
db.createReminder("2","Buy milk","Buy milk at 1 pm","12-03-2025");
db.createReminder("3","Buy groceries","Buy groceries at 2 pm","11-03-2025");
...
console.log(db.getAllReminders());
console.log(db.filterRemindersByDate("11-03-2025"));
